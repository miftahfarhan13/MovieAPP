...
public class FavoriteWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.moviecatalogueuiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.moviecatalogueuiux.EXTRA_ITEM";
